...
/** Helpers */
const isNonEmptyFile = (v: unknown): v is File => v instanceof File && v.size > 0;
const getFiles = (fd: FormData, key: string) =>
...
async function deleteByPrefix(prefix: string, rt: "image" | "raw" | "video") {
  try {
