...
// import { RedoIcon, UndoIcon, RotateCcwIcon } from "lucide-react"; // ⬅️ add RotateCcwIcon
...
//   /** ⬇️ NEW: needed so the header can call the DELETE API */
//   productId: string;
//   /** ⬇️ NEW: optional hook for parent to clear local state after delete */
//   onAfterReset?: () => void;
// }
